...
cap erase tables/table_pooled_panelb.txt
cap erase tables/table_pooled_panelb.xls
cap erase tables/table_pooled_robustness.txt
cap erase tables/table_pooled_robustness.xls
...
foreach field in psych econ math {
	...
	* years since first publication 
	...
	outreg2 using tables/table_pooled_panelb.xls, excel bdec(3) sdec(3) adec(5) append addstat(Log-Likelihood, e(ll), R2, e(r2_p), Sample Size, e(N), Degrees of Freedom of the Model, e(df_m))
	 
	logit new_fellow ///
			(c.Female_1960_1970 c.Female_1980 c.Female_1990 c.Female_2000 c.Female_2010)#fellowship ///
			(year_1960_1979 year_1980_1999 year_2000_2019)# ///
			(c.asinh_cite_total c.*_cite c.*_cumulative i.topcite firstpub_*)#fellowship year#fellowship /// 
			if (NAS_sample == 1 | AAAS_sample == 1) & year < 2020 & year >= 1960, cluster(author) difficult iterate(20)
	outreg2 using tables/table_pooled_robustness.xls, excel bdec(3) sdec(3) adec(5) append addstat(Log-Likelihood, e(ll), R2, e(r2_p), Sample Size, e(N), Degrees of Freedom of the Model, e(df_m))
